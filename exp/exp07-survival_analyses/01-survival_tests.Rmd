...
radiation.sig.genes <- survival.analysis(maf_data = dcis, time = "time.10", event = "event.10", clinsubset = "radiation==TRUE", top = nrow(dcis@gene.summary[dcis@gene.summary$MutatedSamples>5]), pvalue = 0.01)

# Survival analysis non-RT treated patients
noradiation.sig.genes <- survival.analysis(maf_data = dcis, time = "time.10", event = "event.10", clinsubset = "radiation==FALSE", top = nrow(dcis@gene.summary[dcis@gene.summary$MutatedSamples>5]), pvalue = 0.01)
...
plotdf$Gene_combination <- factor(plotdf$Gene_combination, 
                                     levels = rev(c("MYO7A", "HIVEP3", "DNASE2B", "TRIM66", "PDZD8",
                                                "TIGD6", "DERL3", "VSIG10L", "STOX1", "TBL3", "STON1", "NPFFR1")), ordered = TRUE)
...
km <- ggsurvplot(
      combo.all.sig.genes$surv_result$res$MYO7A_PDZD8_DNASE2B_TRIM66_HIVEP3_TIGD6_DERL3_VSIG10L_STOX1_TBL3_STON1_NPFFR1$fit.km, 
      # survfit object with calculated statistics.
      data=combo.all.sig.genes$surv_result$res$MYO7A_PDZD8_DNASE2B_TRIM66_HIVEP3_TIGD6_DERL3_VSIG10L_STOX1_TBL3_STON1_NPFFR1$data,
...
combo.radiation.sig.genes <- survival.analysis(maf_data =radiation.sig.genes$maf, 
                                               ...
                                               geneSetSize = 27, genecombo = 'union', 
                                               time = "time.10", 
                                               event = "event.10", 
                                               pvalue = 0.01) 
...
km <- ggsurvplot(
      combo.radiation.sig.genes$surv_result$res$MAGEC3_EXD3_SH2B2_NPFFR1_ANO6_GLI3_OR4D6_STON1_PCSK1_CAPN9_ZFYVE9_PTPN13_SRRM5_SORBS1_TMEM132C_AADACL3_ABCA2_CEP128_CHD1L_COL5A3_SZT2_RELN_KIAA1217_PATJ_KRT1_WWC1_MAGEC1$fit.km,
      data=combo.radiation.sig.genes$surv_result$res$MAGEC3_EXD3_SH2B2_NPFFR1_ANO6_GLI3_OR4D6_STON1_PCSK1_CAPN9_ZFYVE9_PTPN13_SRRM5_SORBS1_TMEM132C_AADACL3_ABCA2_CEP128_CHD1L_COL5A3_SZT2_RELN_KIAA1217_PATJ_KRT1_WWC1_MAGEC1$data,
      pval = TRUE,             # show p-value of log-rank test.
      conf.int = TRUE,         # show confidence intervals for 
                            # point estimaes of survival curves.
      conf.int.style = "step",  # customize style of confidence intervals
...
cd <- combo.radiation.sig.genes$surv_result$res$MAGEC3_EXD3_SH2B2_NPFFR1_ANO6_GLI3_OR4D6_STON1_PCSK1_CAPN9_ZFYVE9_PTPN13_SRRM5_SORBS1_TMEM132C_AADACL3_ABCA2_CEP128_CHD1L_COL5A3_SZT2_RELN_KIAA1217_PATJ_KRT1_WWC1_MAGEC1$data
...
combo.radiation.sig.genes <- survival.analysis(maf_data = all.sig.genes$maf, 
                                               genes = radiation.sig.genes$genes, 
                                               geneSetSize = 27, 
                                               genecombo = 'union', 
                                               time = "time.10", 
                                               event = "event.10", 
                                               pvalue = 0.01) # not significant when all patients are included
```
...
dat <- combo.radiation.sig.genes$surv_result$res$MAGEC3_EXD3_SH2B2_NPFFR1_ANO6_GLI3_OR4D6_STON1_PCSK1_CAPN9_ZFYVE9_PTPN13_SRRM5_SORBS1_TMEM132C_AADACL3_ABCA2_CEP128_CHD1L_COL5A3_SZT2_RELN_KIAA1217_PATJ_KRT1_WWC1_MAGEC1$data
...
```{r}
# Perform survival analysis on radiation-associated significant genes (gene set size = 27)
combo.radiation.sig.genes <- survival.analysis(maf_data = all.sig.genes$maf, 
                                               genes = radiation.sig.genes$genes, 
                                               geneSetSize = 27, 
                                               genecombo = 'union', 
