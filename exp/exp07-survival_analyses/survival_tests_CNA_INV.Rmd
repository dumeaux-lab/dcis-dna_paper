...
# Filter clinical data for samples in dcis dataset
cl <- cl[cl$Tumor_Sample_Barcode %in% dcis@clinical.data$sample_name,]
...
# Contingency table: event by recurrence type
table(cl$event.10.chr, cl$hist_1st_lr)
...
analyze_cytoband <- function(data) {
  ...
  # Kaplan-Meier analysis for loss
